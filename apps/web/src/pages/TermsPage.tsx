    ...
    <Section spacing="tight">
      <Container size="md">
        ...
        <h1 className="heading-display mt-3 text-4xl font-bold tracking-tight sm:text-5xl">
          Terms and conditions for using Qreative Spaces
        </h1>
        <p className="mt-4 text-base text-muted-foreground">
          By using Qreative Spaces, you agree to these Terms of Service. Please read them carefully
          before using our platform.
        </p>

        <div className="prose prose-neutral mt-10 max-w-none dark:prose-invert">
          <Heading>1. Use of the Platform</Heading>
          <p>You must be at least 18 years old to use Qreative Spaces.</p>
          ...
          <p>
            All ally venues and guests are expected to uphold the Qreative Spaces code of conduct
